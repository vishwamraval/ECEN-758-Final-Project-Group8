...
This project implements classification on the Describable Textures Dataset (DTD) using a baseline SimpleCNN, a deeper ResNet-18 model, and InceptionV3 trained from scratch. The workflow includes data preparation, EDA, hyperparameter tuning, model training, and final evaluation.
